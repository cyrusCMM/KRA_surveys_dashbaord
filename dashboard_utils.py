...
def kra_header(logo_path: str = "assets/kra_logo.png") -> str:
    ...
    <div class="kra-topbar">
        ...
        <div class="kra-accent-space"></div>
    </div>
    """
...
def inject_css() -> str:
    ...
    @media(max-width:1050px){.kra-topbar{height:auto;min-height:145px;flex-direction:column;gap:4px}.kra-brand,.kra-accent-space{width:100%;text-align:center}.main-title{font-size:24px;white-space:normal}.title-line b{font-size:18px}.title-line span{width:60px}.kpi-value{font-size:30px}.kpi-value.small{font-size:18px}}
    </style>
    """
